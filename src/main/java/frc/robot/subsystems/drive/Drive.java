...
public class Drive extends SubsystemBase {
    ...
    public Drive(
        ...
        initPose = new Pose2d(new Translation2d(1.11, 6.72), gyroIO.getYaw());
        poseEstimator = new SwerveDrivePoseEstimator(kinematics, rawGyroRotation, lastModulePositions, initPose);
